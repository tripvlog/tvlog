	...
	<div class="row" id="containerTwo">
		...
		<div class="col-md-2" id="savecontainer">
			<div id="btn-group" class="btn-group" role="group" aria-label="">
				<button type="button" class="btn btn-default">저장하기</button>
				<button type="button" class="btn btn-default">취소</button>
			</div>
			<div id="btn-group2" class="btn-group" role="group" aria-label="">
				<button type="button" class="btn btn-default">방문명소</button>
				<button type="button" class="btn btn-default">여행가계부</button>
				<button type="button" class="btn btn-default">체크리스트</button>
			</div>
		</div>
		<!-- 오른쪽 그룹 - 일정 -->
