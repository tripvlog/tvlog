...
<input type="button" id="cancle" value="목록보기" onclick="javascript:location.href='list.trip'" />
<input type="button" value="페이스북 공유" onclick="javascript:location.href='https://www.facebook.com/sharer.php?u=http://192.168.50.26:8080/tvlog/view.trip?num=${vo.diary_num}'" />
</body>
</html>